...
public class OrderDetailDTO {
    ...
    public @Min(value = 1, message = "Order's ID must be > 0") Long getOrderId() {
        return orderId;
    }

    public void setOrderId(@Min(value = 1, message = "Order's ID must be > 0") Long orderId) {
    ...
    public @Min(value = 0, message = "Product's ID must be >= 0") Float getPrice() {
        return price;
    }

    public void setPrice(@Min(value = 0, message = "Product's ID must be >= 0") Float price) {
        this.price = price;
    }
